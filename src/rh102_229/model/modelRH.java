    ...
    public void simpanDataRH() {
        String sql = ("INSERT INTO reservasi (nama_pemesan, nik, checkin, lama_booking,"
         ...
         try {
             ...
             Logger.getLogger(modelRH.class.getName()).log(Level.SEVERE, null, ex);
             JOptionPane.showMessageDialog(null, "fail"+ex);
         }
    }
    
        
         public void updateDataRH() {
        String sql = "UPDATE reservasi SET nama_pemesan ='"+getNamaPemesanModel()+"'"+
                ", nik = '"+getNikModel()+"'"+", checkin ='" +getCheckInModel()+"'"+
                ", lama_booking = '"+getLamaBookingModel() + "'"+ ", jumlah_kamar = '"+getJumlahKamarModel()+
                "'"+", jenis_kamar ='" +getJenisKamarModel()+ "'"+ ", paket_menu = '"+getPaketMenuModel() +
                 "'"+ ", fasilitas = '"+getFasilitasModel()+"'"+", harga_kamar ='"  +getHargaKamarModel()+ 
                "'"+ ", tambahan = '"+getTambahanModel() + "'"+ ", total_Harga = '"+getTotalHargaModel() +
                "' WHERE id_pesanan = '" + getIdPesananModel()+ "'";
         try {
             PreparedStatement eksekusi = koneksi.getKoneksi().prepareStatement(sql);
             eksekusi.execute();
             ...
             JOptionPane.showMessageDialog(null, "fail update"+ex);
         }
    }
    
    public void hapusDataRH(){
        String sql = "DELETE from reservasi WHERE id_pesanan = " + "'" 
                + getIdPesananModel()+"'";
      ...
      try {
             ...
             JOptionPane.showMessageDialog(null, "done hapus");
         } catch (SQLException ex) {
             JOptionPane.showMessageDialog(null, "fail hapus"+ex);
         }
